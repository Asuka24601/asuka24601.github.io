...
export default function DND5E({ item }: { item: DND5eItemInterface }) {
    ...
    return (
        <div className="mx-auto my-4 w-full font-mono text-sm">
            <div className="border-terminal">
                <TextJitter className="bg-base-100 text-base-content/80 gap-4">
                    {/* Header Section */}
                    ...
                    <div className="grid grid-cols-3 gap-2 sm:grid-cols-6">
                        {abilities.map((ability) => {
                            ...
                            const isSave = item.savingThrows.includes(
                                ability.key
                            )
                            ...
                            return (
                                <div
                                    key={ability.key}
                                    className={`group hover:bg-base-200 relative flex flex-col items-center border p-2 transition-all ${
                                        isSave
                    ...
                    <div className="mt-2 grid grid-cols-1 gap-4 md:grid-cols-2">
                        {/* Skills */}
                        <div className="border-base-content/10 bg-base-200/30 border p-3">
                            <h3 className="text-primary mb-3 flex items-center gap-2 text-xs font-bold uppercase">
                                <span className="text-primary before:content-['>>_SKILLS\_&\_PROFICIENCIES']"></span>
                            </h3>
